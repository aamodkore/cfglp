...
list<Icode_Stmt *> & Basic_Block::compile()
{
	Code_For_Ast ast_code;
	list<Icode_Stmt *> & bb_icode_list = *new list<Icode_Stmt *>;
	
	// Add Label ICode.
	Icode_Stmt * bblabel_code = new Label_IC_Stmt(get_bb_number());
	bb_icode_list.push_back(bblabel_code);
